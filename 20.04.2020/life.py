...
class Life():
    ...
    def detectCollisions(self):
        ...
        self.peacocks_collision_list = pygame.sprite.groupcollide(self.animala.peacocksList, self.animala.tigersList, False, pygame.sprite.collide_mask)
    ...
    def manageEvents(self):
        ...
        self.animala.manageEvents(foodCollisionsList, PeacocksCollisionsList, TigersCollisionsList, window, window_rect, foodList)
